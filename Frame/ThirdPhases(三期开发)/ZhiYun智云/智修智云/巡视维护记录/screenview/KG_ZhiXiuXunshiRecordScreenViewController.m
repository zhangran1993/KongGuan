...
@interface KG_ZhiXiuXunshiRecordScreenViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,WYLDatePickerViewDelegate>
...
@implementation KG_ZhiXiuXunshiRecordScreenViewController
