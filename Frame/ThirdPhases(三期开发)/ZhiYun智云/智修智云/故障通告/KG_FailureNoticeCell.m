...
@end
@implementation KG_FailureNoticeCell
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    KG_FailureNoticeDetailCell *cell = [tableView dequeueReusableCellWithIdentifier:@"KG_FailureNoticeDetailCell"];
    if (cell == nil) {
        cell = [[KG_FailureNoticeDetailCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"KG_FailureNoticeDetailCell"];
    }
