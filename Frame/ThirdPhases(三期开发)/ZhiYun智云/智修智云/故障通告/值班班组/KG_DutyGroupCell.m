...
@implementation KG_DutyGroupCell
...
- (void)setDataDic:(NSDictionary *)dataDic {
    ...
    self.titleLabel.text = [NSString stringWithFormat:@"%@%@",safeString(dataDic[@"position"]),safeString(dataDic[@"name"])];
   
    self.detailLabel.text = safeString(dataDic[@"tel"]);
