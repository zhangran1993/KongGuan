...
@implementation KG_OperationGuideDetailViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    KG_OperationGuideDetailCell *cell = [tableView dequeueReusableCellWithIdentifier:@"KG_OperationGuideDetailCell "];
    if (cell == nil) {
        cell = [[KG_OperationGuideDetailCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"KG_OperationGuideDetailCell"];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    titleLabel.text = [NSString stringWithFormat:@"0%@",safeString(dataDic[@"order"])];
    if ([safeString(dataDic[@"order"]) intValue] >9) {
        titleLabel.text = [NSString stringWithFormat:@"%@",safeString(dataDic[@"order"])];
    }
