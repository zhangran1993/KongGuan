...
- (void)setKongguanDic:(NSDictionary *)kongguanDic {
    _kongguanDic = kongguanDic;
    [self.btn setTitle:safeString(kongguanDic[@"name"]) forState:UIControlStateNormal];
    if ([safeString(kongguanDic[@"name"]) isEqualToString:safeString(self.kongguanDeviceStr)]) {
        [self.btn setTitleColor:[UIColor colorWithHexString:@"#FFFFFF"] forState:UIControlStateNormal];
        [self.btn setBackgroundColor:[UIColor colorWithHexString:@"#2F5ED1"]];
    }else {
        [self.btn setTitleColor:[UIColor colorWithHexString:@"#7C7E86"] forState:UIControlStateNormal];
...
- (void)setKongguanDeviceStr:(NSString *)kongguanDeviceStr {
    _kongguanDeviceStr = kongguanDeviceStr;
}
@end
