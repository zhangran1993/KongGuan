...
@interface KG_StationFileDetailFourthCell ()<UITableViewDelegate,UITableViewDataSource>{
...
@implementation KG_StationFileDetailFourthCell
...
- (void)createSubviewsView {
    ...
    [self.dataArray addObject:@"台站保护距离、净空要求"];
    [self.dataArray addObject:@"台站环境信息"];
    [self.dataArray addObject:@"服务半径"];
