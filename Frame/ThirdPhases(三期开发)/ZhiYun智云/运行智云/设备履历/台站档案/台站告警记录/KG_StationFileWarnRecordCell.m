...
@interface  KG_StationFileWarnRecordCell() <UITableViewDelegate,UITableViewDataSource>{
...
@implementation KG_StationFileWarnRecordCell
...
- (void)createSubviewsView {
    ...
    self.iconImage.image = [UIImage imageNamed:@"kg_stationwarinRecord"];
