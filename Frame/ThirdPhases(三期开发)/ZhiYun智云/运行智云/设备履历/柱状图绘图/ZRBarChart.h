...
///数值数组
@property (nonatomic, strong) NSArray *secondvalueArray;
///渐变色数组
@property (nonatomic, strong) NSArray *secondcolorArray;
///渐变色数组所占位置
@property (nonatomic, strong) NSArray *secondlocations;
