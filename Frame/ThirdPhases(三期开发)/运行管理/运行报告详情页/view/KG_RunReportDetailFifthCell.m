...
@interface  KG_RunReportDetailFifthCell()<UITableViewDelegate,UITableViewDataSource>{
...
@end
@implementation KG_RunReportDetailFifthCell
...
- (void)createSubviewsView {
    ...
    iconImage.image = [UIImage imageNamed:@"runReport_nextDayPromptIcon"];
