...
@interface KG_NewScreenViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,ZRDatePickerViewDelegate>
...
@implementation KG_NewScreenViewController
...
- (void)initCollevtionView{
    ...
    [self.collectionView registerClass:[KG_NewScreenCell class] forCellWithReuseIdentifier:@"KG_NewScreenCell"];
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (collectionView == self.collectionView) {
        ...
        KG_NewScreenCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"KG_NewScreenCell" forIndexPath:indexPath];
...
- (void)confirmMethod:(UIButton *)button {
    if (self.confirmBlockMethod) {
        self.confirmBlockMethod(safeString(self.roomStr), safeString(self.equipTypeStr), safeString(self.alarmLevelStr), safeString(self.alarmStatusStr), safeString(self.startTime), safeString(self.endTime),self.roomArray);
    }
    [self.navigationController popViewControllerAnimated:YES];
