...
@property (nonatomic, strong)   KG_CreateMonthWeiHuModel *dataModel;
...
@implementation KG_CreateMonthWeiHuViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    self.title = @"新建月维护";
    self.dataModel = [[KG_CreateMonthWeiHuModel alloc]init];
    self.dataModel.taskType = @"weekSafeguard";//默认周维护
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    KG_CreateMonthWeiHuCell *cell = [tableView dequeueReusableCellWithIdentifier:@"KG_CreateMonthWeiHuCell"];
    if (cell == nil) {
        cell = [[KG_CreateMonthWeiHuCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"KG_CreateMonthWeiHuCell"];
    }
    if (self.dataArray.count >0) {
        if (indexPath.section == 3) {
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    if (self.dataArray.count == 0) {
        ...
        if (section == 0) {
            ...
            [self.normalBtn setTitle:@"月维护" forState:UIControlStateNormal];
            ...
            [self.yijianBtn setTitle:@"周维护" forState:UIControlStateNormal];
            ...
            if ([self.dataModel.taskType isEqualToString:@"weekSafeguard"]) {
...
- (void)setTaskType:(UIButton *)button {
    ...
    if (i == 1) {
        ...
        self.dataModel.taskType = @"monthSafeguard";//月维护
