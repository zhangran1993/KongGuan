...
@interface KG_CreateYearWeiHuModel : NSObject
...
@property (nonatomic ,copy) NSString *selStartTime;        //开始时间

@property (nonatomic ,copy) NSString *selEndTime;        //结束时间
@end
