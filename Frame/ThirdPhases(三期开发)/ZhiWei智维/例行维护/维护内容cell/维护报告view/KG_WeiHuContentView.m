...
@interface KG_WeiHuContentView ()<UITableViewDelegate,UITableViewDataSource>{
...
@implementation KG_WeiHuContentView
...
{
    KG_WeiHuContentSecondCell *cell = [tableView dequeueReusableCellWithIdentifier:@"KG_WeiHuContentSecondCell"];
    if (cell == nil) {
        cell = [[KG_WeiHuContentSecondCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"KG_WeiHuContentSecondCell"];
        cell.backgroundColor = [UIColor colorWithHexString:@"#FFFFFF"];
    }
   
    cell.selectionStyle = UITableViewCellSelectionStyleNone;
  
    cell.listArray = self.dataArray[indexPath.section][@"childrens"];
//    if(indexPath.row == 0) {
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
   NSArray *arr = self.detailModel.childrens[indexPath.section][@"childrens"] ;
...
- (void)setDetailModel:(taskDetail *)detailModel {
    ...
    [self.dataArray addObjectsFromArray: self.detailModel.childrens];
