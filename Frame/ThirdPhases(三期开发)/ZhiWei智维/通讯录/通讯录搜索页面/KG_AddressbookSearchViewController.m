...
@implementation KG_AddressbookSearchViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    KG_AddressbookSearchCell *cell = [tableView dequeueReusableCellWithIdentifier:@"KG_AddressbookSearchCell"];
    if (cell == nil) {
        cell = [[KG_AddressbookSearchCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"KG_AddressbookSearchCell"];
    }
...
- (void)searchData:(NSString *)search {
    ...
    params[@"type"] = @"eq";
    params[@"content"] = safeString(self.searchId);
