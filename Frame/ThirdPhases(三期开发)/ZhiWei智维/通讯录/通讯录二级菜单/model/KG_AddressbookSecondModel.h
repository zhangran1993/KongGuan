...
@interface seccontacts : NSObject
...
@interface KG_AddressbookSecondModel : NSObject



@property (nonatomic,strong) NSArray <secorgInfo *>*orgInfo;

@property (nonatomic,strong) NSArray <seccontacts *>*contacts;
@end
