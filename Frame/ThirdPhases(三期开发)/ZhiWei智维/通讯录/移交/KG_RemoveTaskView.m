...
@implementation KG_RemoveTaskView
...
-(void)setupDataSubviews
{
    ...
    [confirmBtn setTitle:@"移交" forState:UIControlStateNormal];
...
- (void)addContact:(UIButton *)button {
   ...
   [[NSNotificationCenter defaultCenter] postNotificationName:@"pushRemoveToAddressBook" object:self];
}
//取消
