...
@interface KG_ContactTopThirdView ()<UITableViewDelegate,UITableViewDataSource>{
...
@implementation KG_ContactTopThirdView
...
-(void)setupDataSubviews
{
    ...
    leftIcon.image = [UIImage imageNamed:@"kg_smallSliderBlue"];
    ...
    self.secLabel.textColor = [UIColor colorWithHexString:@"#004EC4"];
    ...
    UIImageView *leftIcon1 = [[UIImageView alloc]init];
    leftIcon1.image = [UIImage imageNamed:@"kg_smallSlider"];
    [headView addSubview:leftIcon1];
    [leftIcon1 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.width.height.equalTo(@14);
        make.left.equalTo(self.secLabel.mas_right);
        make.centerY.equalTo(leftLabel.mas_centerY);
    }];
    
    self.thirdLabel = [[UILabel alloc]init];
    [headView addSubview:self.thirdLabel];
    self.thirdLabel.text = @"技术保障部";
    ...
    [self.thirdLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(leftIcon1.mas_right);
...
- (void)setThirdTitle:(NSString *)thirdTitle {
    ...
    self.thirdLabel.text = safeString(thirdTitle);
}
//搜索方法
