...
- (UILabel *)showYearView {
    if (!_showYearView) {
        ...
        _showYearView.backgroundColor = [UIColor clearColor];
    }
...
-(void)defaultConfig {
    ...
    self.yearArray = [self setArray:_yearArray];
    self.monthArray = [self setArray:_monthArray];
    self.dayArray = [self setArray:_dayArray];
    self.hourArray = [self setArray:_hourArray];
    self.minuteArray = [self setArray:_minuteArray];
