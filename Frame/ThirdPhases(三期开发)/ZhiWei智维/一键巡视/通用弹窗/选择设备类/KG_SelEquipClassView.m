//
//  KG_SelEquipClassView.m
//  Frame
//
//  Created by zhangran on 2020/4/28.
//  Copyright © 2020 hibaysoft. All rights reserved.
//
#import "KG_SelEquipClassView.h"
#import "KG_CommonSelEquipCell.h"
@interface  KG_SelEquipClassView()<UITableViewDelegate,UITableViewDataSource>{
...
@end
@implementation KG_SelEquipClassView
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    KG_CommonSelEquipCell *cell = [tableView dequeueReusableCellWithIdentifier:@"KG_CommonSelEquipCell "];
    if (cell == nil) {
        cell = [[KG_CommonSelEquipCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"KG_CommonSelEquipCell"];
