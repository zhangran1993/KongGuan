//
//  KG_XunJianTaskView.m
//  Frame
//
//  Created by zhangran on 2020/4/28.
//  Copyright © 2020 hibaysoft. All rights reserved.
//
#import "KG_XunJianTaskView.h"
#import "KG_XunJianTaskCell.h"
@interface  KG_XunJianTaskView()<UITableViewDelegate,UITableViewDataSource>{
...
@end
@implementation KG_XunJianTaskView
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    KG_XunJianTaskCell *cell = [tableView dequeueReusableCellWithIdentifier:@"KG_XunJianTaskCell "];
    if (cell == nil) {
        cell = [[KG_XunJianTaskCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"KG_XunJianTaskCell"];
