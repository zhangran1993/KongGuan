...
@property (nonatomic ,copy)NSString * levelCode;
@property (nonatomic ,strong) NSArray <firstData *>*childrens;
@property (nonatomic ,copy)NSString * echarts;
@property (nonatomic ,copy)NSString * cardDisplay;
@property (nonatomic ,copy)NSString * parent;
@property (nonatomic ,copy)NSString * stationName;
...
@interface KG_XunShiReportDataModel : NSObject

@property (nonatomic ,strong) NSArray *label;
@property (nonatomic ,copy)NSString * taskDescription;
@property (nonatomic ,copy)   NSString * showFullTime;
@property (nonatomic ,copy)   NSArray * workPersonName;
@property (nonatomic ,copy)   NSString * taskRange;//黄城导航台-设备机房,油机房,配电室,监控室,UPS间",
