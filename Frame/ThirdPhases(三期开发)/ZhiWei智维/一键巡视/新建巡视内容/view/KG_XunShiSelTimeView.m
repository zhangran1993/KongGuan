...
@interface KG_XunShiSelTimeView ()<UITableViewDelegate,UITableViewDataSource> {
...
@implementation KG_XunShiSelTimeView
...
- (void)initData {
    ...
    [self.cancelBtn  setTitleColor:[UIColor colorWithHexString:@"#24252A"] forState:UIControlStateNormal];
