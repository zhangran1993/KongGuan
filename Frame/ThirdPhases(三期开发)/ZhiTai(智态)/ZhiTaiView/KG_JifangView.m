...
@interface  KG_JifangView()<UITableViewDelegate,UITableViewDataSource>{
...
- (UITableView *)tableView {
    if (!_tableView) {
      CGRect tableViewRect = CGRectMake(0.0, 0.0, 50.0, 250);
...
- (void)setDataDic:(NSDictionary *)dataDic {
    _dataDic =dataDic;
    [self.tableView reloadData];
    self.dataArray = [dataDic allKeys];
