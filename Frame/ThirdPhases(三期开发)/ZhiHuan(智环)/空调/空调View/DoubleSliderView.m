...
- (UIView *)midLineView {
    if (!_midLineView) {
        ...
        _midLineView.backgroundColor = [UIColor colorWithHexString:@"#C8CFE1"];
...
- (UIButton *)minSliderBtn {
    if (!_minSliderBtn) {
        ...
        _minSliderBtn.size = CGSizeMake(8, 24);
        _minSliderBtn.backgroundColor = [UIColor colorWithHexString:@"#C8CFE1"];
...
- (UIButton *)maxSliderBtn {
    if (!_maxSliderBtn) {
        ...
        _maxSliderBtn.size = CGSizeMake(8,24);
        _maxSliderBtn.backgroundColor = [UIColor colorWithHexString:@"#C8CFE1"];
