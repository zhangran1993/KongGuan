...
@interface KG_KongTiaoDetailViewController ()<UITableViewDataSource,UITableViewDelegate,WKNavigationDelegate>
...
@implementation KG_KongTiaoDetailViewController
