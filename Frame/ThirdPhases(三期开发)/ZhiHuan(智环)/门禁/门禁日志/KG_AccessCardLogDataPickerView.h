...
typedef enum : NSUInteger {
    AccessDatePickerTypeYMDHMS,
    AccessDatePickerTypeYMDHM,
    AccessDatePickerTypeYMD,
    AccessDatePickerTypeYM,
    AccessDatePickerTypeY
} AccessDatePickerType;



@protocol AccessDatePickerViewDelegate <NSObject>
...
@interface KG_AccessCardLogDataPickerView : UIView
...
@property (weak, nonatomic) id <AccessDatePickerViewDelegate> delegate;
